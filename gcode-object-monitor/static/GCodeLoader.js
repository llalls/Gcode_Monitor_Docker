...
THREE.GCodeLoader.prototype.objectViewer = function ( layers ){

	/*set transparent color to printer moving path*/
	var pathMaterial = new THREE.LineBasicMaterial( {color: 0xff0000, transparent: true, alpha: true, opacity: 0.0} );
	pathMaterial.name = 'path';
